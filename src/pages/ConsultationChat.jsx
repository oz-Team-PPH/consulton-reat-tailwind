...
【예상 투입 시간】 3-6개월 장기 프로젝트`;
  ...
  const handleContinueWithCredits = () => {
    // 50크레딧으로 더 대화하기 기능 (임시로 alert 표시)
    alert(
      "50크레딧을 사용하여 더 대화할 수 있습니다.\n크레딧 결제 기능이 구현될 예정입니다."
    );
  };

  const handleCommunitySummaryPost = () => {
    // 요약해서 커뮤니티에 상담요청 글쓰기 (임시로 alert 표시)
            ...
            <div className="p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  상담 내용을 분석하여 다음 단계를 제안합니다. 어떤 방법을
                  선택하시겠어요?
                </p>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 px-4 rounded-lg font-medium hover:from-blue-600 hover:to-purple-700 transition-all duration-200 shadow-sm hover:shadow-md"
                    >
                      <div className="text-center">
                        <div>대화 연장하기</div>
                    ...
                    <button
                      onClick={handleCommunitySummaryPost}
                      className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-3 px-4 rounded-lg font-medium hover:from-green-600 hover:to-emerald-700 transition-all duration-200 shadow-sm hover:shadow-md"
                    >
                      커뮤니티 글쓰기
                    </button>
                  </div>
