...
const NotificationSettings = () => {
  ...
  const notificationTypes = {
    email: {
      ...
      icon: Mail,
      options: [
        { key: 'newConsultation', label: '새로운 상담 요청', description: '전문가가 새로운 상담을 시작할 때' },
        { key: 'consultationReminder', label: '상담 일정 알림', description: '예정된 상담 30분 전' },
        { key: 'expertResponse', label: '전문가 응답', description: '전문가가 메시지에 답변할 때' },
        { key: 'summaryReady', label: '상담 요약 완료', description: '상담 요약 및 녹화본이 준비되었을 때' },
        { key: 'weeklyReport', label: '주간 리포트', description: '주간 상담 활동 요약' },
        { key: 'promotions', label: '프로모션 및 혜택', description: '특별 할인 및 새로운 서비스 소식' }
      ]
    },
    push: {
      title: '푸시 알림',
    ...
    sms: {
      ...
      icon: MessageSquare,
      options: [
        { key: 'consultationReminder', label: '상담 일정 알림', description: '예정된 상담 1시간 전' },
        { key: 'urgentUpdates', label: '긴급 업데이트', description: '시스템 점검 등 중요한 공지사항' }
      ]
    }
  };
        ...
        <div className="space-y-8">
              ...
              <div className="space-y-4">
                {config.options.map((option) => (
                  <NotificationToggle
                    ...
                    onChange={(checked) => handleSettingChange(category, option.key, checked)}
                  />
                ))}
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900">인앱 알림</h2>
            ...
            <div className="space-y-4">
              <NotificationToggle
                ...
                onChange={(checked) => handleSettingChange('inApp', 'all', checked)}
              />
              ...
              {settings.inApp.all && (
                <>
                  <NotificationToggle
                    ...
                    onChange={(checked) => handleSettingChange('inApp', 'sound', checked)}
                  />
                  ...
                  <NotificationToggle
                    ...
                    onChange={(checked) => handleSettingChange('inApp', 'vibration', checked)}
                  />
                </>
              )}
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900">방해 금지 시간</h2>
                <p className="text-sm text-gray-600">특정 시간대에는 알림을 받지 않습니다</p>
              </div>
            </div>
          ...
          {/* 알림 빈도 설정 */}
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">알림 빈도</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleSettingChange('frequency', 'emailDigest', e.target.value)}
                  className="block w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleSettingChange('frequency', 'pushSummary', e.target.value)}
                  className="block w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                >
                  <option value="immediate">즉시</option>
