...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
            ...
            <div className="p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  현재 진행 중인 AI 상담이 저장되지 않고 종료됩니다. 계속하시겠습니까?
                </p>
              </div>
      ...
      {/* 사이드바 */}
      <div
        className={`fixed top-0 left-0 bottom-0 z-30 bg-white border-r border-gray-200 transform transition-all duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="hidden lg:flex items-center justify-end p-2 border-b border-gray-200">
            ...
            >
              <PanelLeftClose className={`h-4 w-4 transition-transform duration-300 ${isCollapsed ? 'rotate-180' : ''}`} />
            </button>
          </div>
                  ...
                  return (
                    <button
                      ...
                      className={`w-full group relative overflow-hidden rounded-xl transition-all duration-300 ${
                        isCollapsed ? 'p-3' : isQuickAI ? 'p-4' : 'p-3'
                      } ${
                        isQuickAI
                          ...
                          <div className={`p-2 rounded-lg transition-all duration-300 ${
                            ...
                            <IconComponent
                              className={`h-5 w-5 ${
                                isQuickAI
                                  ? "text-white"
                                  : isActive ? "text-gray-700" : "text-gray-600 group-hover:text-blue-600"
                        ...
                        {!isCollapsed && (
                          <div className="flex items-center space-x-2">
                            ...
                            <ChevronRight
                              ...
                              } ${isQuickAI || isActive ? "transform translate-x-1" : ""}`}
                            />
                          </div>
                        )}
                      </div>
